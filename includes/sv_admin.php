...
function register_svsettings() {
    ...
    register_setting( 'sv-settings-group', 'sv_email_mandatory' );
    register_setting( 'sv-settings-group', 'sv_email_invalid' );
    ...
    register_setting( 'sv-settings-group', 'sv_linkedin_share_text' );
    ...
    register_setting( 'sv-settings-group', 'sv_twitter_hashtag' );
    register_setting( 'sv-settings-group', 'sv_twitter_share_text' );
...
function sv_settings_page() { 
    ...
    jQuery( document ).ready(function() {
        jQuery("#svSettingsTabs").on('click','a',function(){
            jQuery("#svSettingsTabs a").removeClass("nav-tab-active");
            jQuery(this).addClass("nav-tab-active");
            jQuery("#svGeneralTab").hide();
            jQuery("#svFacebookTab").hide();
            jQuery("#svLinkedInTab").hide();
            jQuery("#svTwitterTab").hide();
            jQuery("#svEmailTab").hide();
            ...
            <div id="svSettingsTabs">
                ...
                <div id="svGeneralTab" style="display:block">
                    ...
                    <table class="form-table">
                        ...
                        <tr valign="top" class="customPostTr">
                            <th scope="row">Email Mandatory Message</th>
                                <td>
                                    <textarea name="sv_email_mandatory" rows="5" cols="95"
                                     id="sv_email_mandatory"> <?php echo get_option('sv_email_mandatory'); ?> </textarea>
                                     <br/><small>Mandatory field.</small>
                                </td>
                            </th>
                        </tr>

                        <tr valign="top" class="customPostTr">
                            <th scope="row">Email Invalid Message</th>
                                <td>
                                    <textarea name="sv_email_invalid" rows="5" cols="95"
                                     id="sv_email_invalid"> <?php echo get_option('sv_email_invalid'); ?> </textarea>
                                     <br/><small>You have entered an invalid email address.</small>
                                </td>
                            </th>
                        </tr>
                ...
                <div id="svLinkedInTab" style="display:none">
                    ...
                    <table class="form-table">
                        ...
                        <tr valign="top">
                            <th scope="row">LinkedIn Share Text</th>
                            <td>
                                <textarea name="sv_linkedin_share_text" id="sv_linkedin_share_text" ><?php echo get_option('sv_linkedin_share_text'); ?></textarea>
                                <br/><small>Please enter share text for LinkedIn. <br/>Use #title# to replace current page title.</small>
                            </td>
                        </tr>
                    </table>
                ...
                <div id="svTwitterTab" style="display:none">
                    ...
                    <table class="form-table">
                        ...
                        <tr valign="top">
                            <th scope="row">Twitter Hash Tag</th>
                            <td>
                                <input type="text" name="sv_twitter_hashtag" id="sv_twitter_hashtag" value="<?php echo get_option('sv_twitter_hashtag'); ?>" />
                            </td>
                        </tr>
                        <tr valign="top">
                            <th scope="row">Twitter Share Text</th>
                            <td>
                                <textarea name="sv_twitter_share_text" id="sv_twitter_share_text" ><?php echo get_option('sv_twitter_share_text'); ?></textarea>
                                <br/><small>Please enter share text for Twitter. <br/>Use #title# to replace current page title.</small>
                            </td>
                        </tr>
                    </table>
